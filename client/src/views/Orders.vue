...
export default {
  ...
  setup() {
    ...
    const loadOrders = async () => {
      ...
      // Load restocking orders independently — a failure here must not break the main orders view
      try {
...
/* The submitted orders table has a different column mix — allow layout reset */
